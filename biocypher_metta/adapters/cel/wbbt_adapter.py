...
class WbbtAdapter(OntologyAdapter):
    ONTOLOGIES = {
        'wbbt': 'http://purl.obolibrary.org/obo/wbbt.owl'
    }
    ...
    def get_ontology_source(self):
        return 'WBbt', 'http://purl.obolibrary.org/obo/wbbt.owl'

    def get_uri_prefixes(self):
        return {
            'primary': 'http://purl.obolibrary.org/obo/WBbt_',
        }
