    ...
    def get_edges(self):
        ...
        for row in rows:
            ...
            if len(source) == 1 and len(target) == 1:
                ...
                props['taxon_id'] = 7227
                yield f'ENSEMBL:{source}', f'ENSEMBL:{target}', self.label, props
            #
                ...
                for source_id in source:
                    ...
                    props['reference'] = row[5]
                    props['taxon_id'] = 7227
                    yield f'ENSEMBL:{source_id}', f'ENSEMBL:{target}', self.label, props
            #
            elif len(source) == 1 and len(target) > 1:
                source = source[0]
                for target_id in target:
                    ...
                    props['reference'] = row[5]
                    props['taxon_id'] = 7227
                    yield f'ENSEMBL:{source}', f'ENSEMBL:{target_id}', self.label, props
            #
            elif len(source) > 1 and len(target) > 1:
                for source_id in source:
                    for target_id in target:
                        ...
                        props['reference'] = row[5]
                        props['taxon_id'] = 7227
                        yield f'ENSEMBL:{source_id}', f'ENSEMBL:{target_id}', self.label, props