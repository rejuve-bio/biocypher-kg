...
class EVAAdapter(Adapter):
    ...
    def __init__(
        ...
        meta = self.SPECIES_INFO.get(taxon_id, {})
        self.source = f"EVA Release 9 – {meta.get('full_name', str(taxon_id))}"
        self.source_url = meta.get("eva_source_url", "https://www.ebi.ac.uk/eva/")
