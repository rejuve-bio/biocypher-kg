...
class MmusDvAdapter(OntologyAdapter):
    ONTOLOGIES = {
        'mmus_dv': 'http://purl.obolibrary.org/obo/mmusdv.owl'
    }
    ...
    def get_ontology_source(self):
        return 'MMUSDV', 'http://purl.obolibrary.org/obo/mmusdv.owl'

    def get_uri_prefixes(self):
        return {
            'primary': 'http://purl.obolibrary.org/obo/MmusDv_',
        }
