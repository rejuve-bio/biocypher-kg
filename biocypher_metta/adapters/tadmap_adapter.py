...
class TADMapAdapter(Adapter, ChromosomeChainMixin):
    """
    ...
    def get_nodes(self):
        ...
        with open(self.filepath, 'r') as tad_file:
            ...
            for row in tad_file:
                ...
                start = int(loc_info[TADMapAdapter.INDEX['start']])
                end = int(loc_info[TADMapAdapter.INDEX['end']])
                genes = []
        ...
        with open(self.filepath, 'r') as tad_file:
            ...
            for row in tad_file:
                ...
                if check_genomic_location(self.chr, self.start, self.end, chr, start, end):
                    ...
                    elif self.label == 'tad_located_on_chain':
                        yield from self.get_located_on_chain_edges(_id, chr, start, end)